    ...
    <div className="min-h-screen bg-cozy-background flex items-center justify-center py-12">
      <Container className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <Headline level={2} className="mb-2 text-cozy-heading">Sign In</Headline>
          <Body>Welcome back! Sign in to continue.</Body>
        </div>
        ...
        <Card className="p-8">
          {/* Info Message */}
          {info && (
            <div className="mb-6 p-4 bg-cozy-mount border border-cozy-borderCard rounded-cozy-md">
              <div className="flex items-center gap-2">
                <svg
                  className="w-5 h-5 text-cozy-accent shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-sm text-cozy-text">{info}</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-cozy-heading mb-1 font-serif">
                Email
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-cozy-heading mb-1 font-serif">
                Password
              </label>
              <div className="relative">
                ...
                <button
                  ...
                  disabled={isLoadingState}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-cozy-textSecondary hover:text-cozy-accent disabled:opacity-50"
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-sm text-cozy-accent hover:underline font-serif">
                Forgot password?
              </Link>
            </div>

            <Button type="submit" disabled={isLoadingState} variant="primary" size="large" fullWidth className="flex items-center justify-center gap-2">
              {isLoadingState ? (
                <>
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-cozy-borderCard" />
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-cozy-surface text-cozy-textSecondary font-serif">Or sign in with Google</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Caption className="text-center block">Support for additional providers is coming soon.</Caption>
          </div>

          <div className="mt-6 text-center">
            <Body>
              Don&apos;t have an account?{' '}
              <Link href="/sign-up" className="text-cozy-accent font-medium hover:underline">
                Sign up
              </Link>
            </Body>
          </div>
        ...
        <div className="mt-8 text-center">
          <Caption>
            ...
            <Link href="/terms" className="text-cozy-accent hover:underline">Terms of Service</Link>
            {' '}and{' '}
            <Link href="/privacy" className="text-cozy-accent hover:underline">Privacy Policy</Link>
          </Caption>
        </div>
      </Container>
    </div>
